...
def train(data_dir : str | Path, labels : pd.DataFrame, artifacts_dir, progress_callback : Callable | None = None):
    """
    ...
    try:
        ...
        _train(labels=labels, progress_callback=progress_callback)
        return True, None
...
def get_config() -> dict:
    ...
    return {
        ...
        "models":{ "value": config.MODELS, "desc": "Zu trainierende Modelltypen", "options": ["randomforest", "logreg"] },
